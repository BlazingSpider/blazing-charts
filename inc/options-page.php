...
//				'amcharts_cdn' => '0',
		...
		<div class="wrap">
			...
			<h3>HighCharts:</h3>
			<p><strong>HighCharts</strong> and its auxiliary libraries are loaded remotely. to load auxiliary libraries, along with main library, you should specify them, as a comma-separated list, in the shortcode as following:<br>
			...
			<h3>ZingChart</h3>
			<p><strong>ZingChart</strong> license is not GPL compatible, so can only be loaded remotely.</p>
			<p>This plugin does NOT substitute <strong>ZingChart</strong> terms of use. Please refer to ZingChart license page http://www.zingchart.com/buy/ to check the precise license conditions.</p>
			<h3>Google Charts</h3>
			...
			<h3>Chart.js</h3>
			<p><strong>Chart.js</strong> can only be loaded locally, and I could not find a CDN hosting it.
